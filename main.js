...
import { renderProducts, renderMissingProducts } from './scripts/product/renderProduct';
import { selectPayImmediately, setTotalSum } from './scripts/total';
import { addFavorite, changeCollapse, changeCount, deleteProduct, selectAllProduct, selectProduct, setCountButtonColor, updatePrice, updatedProducts } from './scripts/product/updateProduct';
import { renderDeliveryDateInfo } from './scripts/delivery';
import { closeModal, defineDeliveryType, openModal } from './scripts/modal/modal';
import { formatPhoneNumber } from './scripts/utils/validate';
import { removeError, validateForm, validateInput } from './scripts/recipientForm';
